  ...
  const projects = [
    {
      ...
      files: [
        { name: "homepage.docx", size: "2.3 MB", uploaded: "2024-01-08" },
        { name: "products.pdf", size: "1.8 MB", uploaded: "2024-01-08" },
      ],
    },
    {
      id: "PRJ-002",
      ...
      files: [{ name: "brochure.indd", size: "5.2 MB", uploaded: "2024-01-05" }],
    },
    {
      id: "PRJ-003",
      ...
      files: [
        { name: "contract.pdf", size: "3.1 MB", uploaded: "2024-01-02" },
        { name: "addendum.docx", size: "890 KB", uploaded: "2024-01-03" },
      ],
    },
  ]
